...
const Footer = () => {
  return (
    <>
      <div className="relative overflow-hidden bg-white px-8 py-10">
          ...
          <div className="-m-8 flex flex-wrap items-center justify-between">
            ...
            <div className="w-auto p-8">
              <div className="-m-1.5 flex flex-wrap">
                <div className="w-auto p-1.5">
                  <Link to="https://www.facebook.com/sourav.halder.777158" target='_blank'>
                ...
                <div className="w-auto p-1.5">
                  <Link to="https://play.google.com/store/books/details?id=pPibEAAAQBAJ" target='_blank'>
                    <div className="flex h-8 w-8 items-center justify-center rounded-full border border-gray-300 hover:border-gray-400">
                      <svg
                        width="18"
                        height="18"
                ...
                <div className="w-auto p-1.5">
                  <Link to="https://instagram.com/madly_ordinary" target='_blank'>
                    <div className="flex h-8 w-8 items-center justify-center rounded-full border border-gray-300 hover:border-gray-400">
                      <svg
                        width="16"
                        height="15"
            ...
            <div className="w-auto p-8">
              <ul className="-m-5 flex flex-wrap items-center">
                <li className="px-5 py-3">
                  <Link className="font-myfont font-medium text-sm text-gray-500 hover:text-gray-900" to="#">
                    Privacy Policy
                  </Link>
                </li>
                <li className="px-5 py-3">
                ...
                <li className="px-5 py-3">
                  <Link className="font-myfont font-medium text-sm text-gray-500 hover:text-gray-900" to="/contact">
                    Contact Me
                  </Link>
                </li>
              </ul>
            ...
            <div className="w-auto p-8">
              <div className="inline-flex items-center">
                <span>
                  <p className="font-myfont text-sm text-gray-400 ">
                    &copy; 2024 by Sourav Halder.
                  </p>
                </span>
              </div>
            </div>
